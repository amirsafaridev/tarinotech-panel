...
return [
    ...
    */
    'drivers' => [
        ...
        'sep' => [
            'apiGetToken' => 'https://sandbox.banktest.ir/saderat/sepehr.shaparak.ir/V1/PeymentApi/GetToken',
            'apiPaymentUrl' => 'https://sandbox.banktest.ir/saderat/sepehr.shaparak.ir/Pay',
            'apiVerificationUrl' => 'https://sandbox.banktest.ir/saderat/sepehr.shaparak.ir/V1/PeymentApi/Advice',
            'terminalId' => '134755497',
            'callbackUrl' => '',
            'description' => 'Saman Electronic Payment for Saderat & Keshavarzi',
            'currency' => 'R', //Can be R, T (Rial, Toman)
        ],
        'sepehr' => [
            'apiGetToken' => env('SEPEHR_API_GET_TOKEN_URL'),
            'apiPaymentUrl' => env('SEPEHR_API_PAYMENT_URL'),
            'apiVerificationUrl' => env('SEPEHR_API_VERIFICATION_URL'),
            'terminalId' => env('SEPEHR_TERMINAL_ID', 134755497),
    ...
    */
    'map' => [
        ...
        'sepehr' => \App\Service\PaymentDriver\SepehrDriver::class,
