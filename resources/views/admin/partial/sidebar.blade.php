    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                @canany(['ADMIN_ADMIN_INDEX','ADMIN_ADMIN_CREATE','ADMIN_ADMIN_JOB_TITLE_INDEX','ADMIN_ADMIN_GROUP_GOAL','ADMIN_REPORT_GOAL','ADMIN_REPORT_GOAL_GROUP','ADMIN_ADMIN_PERSONNEL_ASSISTANCE_INDEX','ADMIN_ADMIN_PERSONNEL_SALARY_INDEX','ADMIN_ADMIN_PERSONNEL_REPORT_INDEX', 'ADMIN_ADMIN_VARIABLE_AMOUNT_INDEX', 'ADMIN_ADMIN_FIXED_AMOUNT_INDEX'])
                    <li class="sub-category">
                        <h3>مدیریت پرسنل</h3>
                    </li>
                    ...
                    <li class="slide can-expand">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a href="{{ route('admin.admin.fixed-amount.index') }}" class="slide-item">مبالغ ثابت</a></li>
                            @endcan
                            @can('ADMIN_ADMIN_VARIABLE_AMOUNT_INDEX')
                            <li><a href="{{ route('admin.admin.variable-amount.index') }}" class="slide-item">مبالغ متغیر</a></li>
                            @endcan
