            ...
            <div class="card">
                <div class="card-body pb-4">
                    ...
                    <form class="request-form forms-sample" method="post" action="{{ $routeStore }}">
                        ...
                        <x-admin.select-enum identify="person_type" title="نوع شخص" :enum-class="\App\Enums\Database\User\PersonType::class"/>
                        ...
                        <x-admin.select-enum identify="irnic_status" title="شناسه ایرنیک" :enum-class="\App\Enums\Database\User\IrnicStatus::class"/>
