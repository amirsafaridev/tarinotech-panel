...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">انواع واریزی</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ trans('panel.dashboard.title') }}</a></li>
                <li class="breadcrumb-item active">انواع واریزی</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">انواع واریزی</h3>
                    <a class="btn btn-success btn-sm" href="{{ route('admin.transaction-category.create') }}">ایجاد نوع</a>
                </div>
                <div class="card-body">
