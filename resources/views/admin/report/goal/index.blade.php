                    ...
                    <form method="get" action="{{ route('admin.goal.report') }}">
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-3">
                                <x-admin.select-model title="انتخاب کارشناس" :items="$admins" identify="admin_id" key="id" value="fullName"/>
                            </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function (){
            ...
            @if(request('admin_id'))
                $('#admin_id').val(parseInt('{{ request('admin_id') }}'))
            @endif
        })
    </script>
@endsection
