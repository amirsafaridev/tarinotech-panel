...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">تقویم تعطیلات</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ trans('panel.dashboard.title') }}</a></li>
                <li class="breadcrumb-item active">تقویم تعطیلات</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">تقویم تعطیلات</h3>
                    <a class="btn btn-success btn-sm" href="{{ route('admin.free-day.create') }}">ایجاد</a>
                </div>
                <div class="card-body">
