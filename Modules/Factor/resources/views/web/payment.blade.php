...
@section('content')
    <div class="container">
        <div class="col-12 col-md-6 mx-auto vh-100 px-4 d-flex flex-column justify-content-center align-items-center" style="background-color: #f4f4f4">
            ...
            <a class="btn btn-success w-100" href="">پرداخت انلاین</a>
        </div>
