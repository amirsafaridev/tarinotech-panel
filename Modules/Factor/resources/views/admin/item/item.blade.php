...
<div class="card card-factor-item">
    ...
    <div class="card-body pb-4">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-2">
                <x-admin.input identify="item[{{ $_index }}][tax]" title=" مالیات بر ارزش افزوده {{ config('factor.tax') * 100 }} درصد (ریال)" :add-class="['tax-input','calc']" :read-only="true" :old="$taxAmount"/>
            </div>
            <div class="col-12 col-md-4 col-lg-2">
