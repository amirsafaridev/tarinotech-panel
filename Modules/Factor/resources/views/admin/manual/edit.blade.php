    ...
    <div class="page-header">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.factor.manual.index') }}">فاکتور ها (تایید پرداخت دستی)</a></li>
                <li class="breadcrumb-item active">تایید</li>
            </ol>
        </div>
    </div>

    <form class="row request-form forms-sample" method="post" action="{{ route('admin.factor.manual.update',$factor->id) }}">
        @method('PATCH')
