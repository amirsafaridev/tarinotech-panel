            ...
            <div class="card">
                <div class="card-body pb-4">
                    ...
                    <form class="request-form forms-sample" method="post"
                        action="{{ route('admin.admin.payslip-text-manager.store') }}">
                        @csrf

                    
                        <x-admin.textarea identify="start_text" title="متن شروع" />
                        <x-admin.textarea identify="end_text" title="متن پایان" />
