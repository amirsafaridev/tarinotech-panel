...
@section('content')
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
            <div class="card">
                <div class="card-body pb-4">
                    ...
                    <form class="request-form forms-sample" method="post" action="{{ route('admin.admin.fixed-amount.update',$fixedAmount->id) }}">
                        @csrf
                        @method('PATCH')
                            ...
                            <x-admin.input identify="employer_insurance_remote" title="بیمه سهم کارفرما(دورکاری)" :old="$fixedAmount->employer_insurance_remote"/>
                            <x-admin.input identify="personnel_insurance_remote" title="بیمه سهم پرسنل(دورکاری)" :old="$fixedAmount->personnel_insurance_remote"/>
    ...
    <form id="deleteItem" action="{{ route('admin.admin.fixed-amount.destroy',$fixedAmount->id) }}" method="post" class="form-inline">
        @csrf
        @method('DELETE')
    </form>
@endsection
