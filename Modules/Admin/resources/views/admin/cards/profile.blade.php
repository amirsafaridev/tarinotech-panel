@php
    ...
    $jobTitleId = $admin->job_title_id ?? null;
    $tel = $admin->tel ?? null;
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <x-admin.input identify="avatar"
                       title="تصویر"
                       type="file"/>

        <x-admin.input identify="first_name"
                       title="نام"
                       :old="$firstName"/>
        ...
        <x-admin.input identify="postal_code"
                       title="کد پستی"
                       :old="$postalCode"/>

        <x-admin.input identify="national_code"
                       title="کد ملی"
                       :old="$nationalCode"/>
