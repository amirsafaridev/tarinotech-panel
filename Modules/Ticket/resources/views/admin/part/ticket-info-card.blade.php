@php
    ...
    use Modules\Admin\app\Models\Admin;$ticketDetail = $ticketDetail ?? (isset($chat) ? $chat->ticketDetail : null);
            ...
            <div class="ticket-info p-3">
                <div class="table-responsive">
                    <table class="table table-sm m-0">
                        ...
                        <tr>
                            ...
                            <td>{{ optional($chat->users->where('user_type', '!=', Admin::class)->first()->user)->fullname }}</td>
                        </tr>
                        <tr>
                            <td class="fw-bold">
                ...
                <div class="d-flex justify-content-between mt-3 p-3 bg-light">
                    <div>
                        ...
                        <span class="badge"
                              style="background-color: {{ optional($ticketDetail->status)->color ?? '#999' }}">
                    ...
                    <div>
                        ...
                        <span class="badge"
                              style="background-color: {{ optional($ticketDetail->priority)->color ?? '#999' }}">
