    ...
    <form class="request-form row forms-sample" method="post" action="{{ route('admin.project.web.edit', $project->id) }}">
        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <x-admin.checkbox identify="have_domain" description="دامنه دارد؟" :old="$project->target->domains['have_domain']" />
                    ...
                    <div class="row d-none" id="domain_container">
                        ...
                        <div class="col-12 col-md-6">
                            <x-admin.input identify="domain_username" title="نام کاربری دامنه" :old="$project->target->domains['domain_username']" />
                        </div>
                        <div class="col-12 col-md-6">
                            <x-admin.input identify="domain_password" title="رمز عبور دامنه" :old="$project->target->domains['domain_password']
                                ? Crypt::decrypt($project->target->domains['domain_password'])
                                : ''" />
                        </div>
                    </div>
                    ...
                    <x-admin.select-enum identify="domains_required[]" title="دامنه های موردنیاز جهت خرید" :multiple="true"
                        :with-option="false" :enum-class="\Modules\Project\app\Enums\WebDomain::class" :old="$project->target->domains['domains_required']" />

                    <x-admin.input identify="other_domain" title="نام دامنه دیگر را وارد کنید" :old="$project->target->domains['other_domain']" />
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <x-admin.checkbox identify="have_host" description="هاست دارد؟" :old="$project->target->host['have_host']" />
                    ...
                    <div class="row d-none" id="host_container">
                        ...
                        <div class="col-12 col-md-6">
                            <x-admin.input identify="host_username" title="نام کاربری" :old="$project->target->host['host_username']" />
                        </div>
                        <div class="col-12 col-md-6">
                            <x-admin.input identify="host_password" title="رمز" :old="$project->target->host['host_password']
                                ? Crypt::decrypt($project->target->host['host_password'])
                                : ''" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <x-admin.select-enum identify="host_location" title="لوکیشن هاست؟"
                            ...
                            :with-option="false" :enum-class="\Modules\Project\app\Enums\WebHostLocation::class" :old="$project->target->host['host_location']" />
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <x-admin.select-enum identify="primary_language" title="زبان اصلی" :with-option="false" :enum-class="\Modules\Project\app\Enums\WebLanguage::class"
                    ...
                    <x-admin.select-enum identify="languages[]" title="زبان ها" :multiple="true" :with-option="false"
                        :enum-class="\Modules\Project\app\Enums\WebLanguage::class" :old="$project->target->language['languages']" />
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body pb-4">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <x-admin.select-model identify="type_id" title="نوع پروژه" :items="$types"
                                :old="$project->type_id" :has-choice-option="false" key="id" value="title" />
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <x-admin.select-model identify="business_domain_id" title="زمینه کاری" :items="$businessDomains"
                                :old="$project->business_domain_id" key="id" value="title" />
                        </div>
                        <div class="col-12 col-md-6">
                            <x-admin.input identify="business_domain" title="زمینه کاری (متنی)" :old="$project->business_domain" />
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-12 col-md-6">
                            <x-admin.input identify="pages" title="تعداد صفحات داخلی" :old="$project->target->pages" />
                        </div>
                        <div class="col-12 col-md-6">
                            <x-admin.input identify="total_workdays" readOnly='true' title="مدت زمان (روز کاری)" />
                        </div>
                        <div class="col-12 col-md-6">
                            <x-admin.input identify="deadline_at" title="تاریخ تحویل" :old="verta($project->deadline_at)->format('Y/m/d')" />
                        </div>
                        <div class="col-12">
                    ...
                    <x-admin.textarea identify="similar_sites" title="سایت های مشابه"
                        description="از نظر موضوعی و زمینه فعالیت مانند رقبا" :old="implode(PHP_EOL, $project->target->sample['similar_sites'])" />

                    <x-admin.textarea identify="favorite_sites" title="سایت های مورد پسند" :old="implode(PHP_EOL, $project->target->sample['favorite_sites'])" />
