...
@section('content')
    ...
    <form class="row" action="{{ route('admin.project.web.index') }}">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        @can('ADMIN_PROJECT_WEB_IMPORT_INDEX')
                            <a class="btn btn-success" href="{{ route('admin.project.web.import.index') }}">ایمپورت</a>
                        @endcan
                    </div>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @can('ADMIN_PROJECT_WEB_DESTROY')
                                                        <a class="dropdown-item delete-item" href="javascript:void(0)" data-id="{{ $project->id }}" data-title="{{ $project->title }}">{{ __('panel.action.delete') }}</a>
                                                    @endcan
                                                </div>
                                            </div>
                                        </td>
    ...
    <script>
        $(document).ready(function (){
            ...
            $('.delete-item').on('click', function() {
                ...
                $('#delete-form').attr('action', `{{ route('admin.project.web.destroy', '') }}/${id}`);
