        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="card">
                <div class="card-body pb-3">
                    ...
                    <form class="request-form forms-sample" method="post" action="{{ route('admin.blog.category.update',$blogCategory->id) }}">
                        @csrf
                        @method('PATCH')
                    ...
                    <form id="deleteItem" action="{{ route('admin.blog.category.destroy',$blogCategory->id) }}" method="post" class="form-inline">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
