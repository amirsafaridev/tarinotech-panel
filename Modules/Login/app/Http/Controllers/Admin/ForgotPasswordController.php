...
use Modules\Login\app\Http\Requests\Admin\ForgetPasswordRequest;
use Modules\Login\app\Models\OtpCode;
use Modules\Login\app\Notifications\Admin\OtpCodeEmail;
use Modules\Login\app\Notifications\Admin\OtpCodeSms;
...
class ForgotPasswordController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('login::admin.passwords.forget', compact('title'));
    }
