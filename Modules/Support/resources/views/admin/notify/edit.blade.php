    ...
    <div class="page-header">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.support.notify.index') }}">اطلاعیه ها</a></li>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="card">
                <div class="card-body pb-3">
                    ...
                    <form class="request-form forms-sample" method="post" action="{{ route('admin.support.notify.update',$chat->id) }}">
                        @csrf
                        @method('PATCH')
