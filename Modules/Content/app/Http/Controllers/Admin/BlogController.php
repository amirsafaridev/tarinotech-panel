...
use Modules\Content\app\Http\Requests\Admin\Blog\StoreRequest;
use Modules\Content\app\Http\Requests\Admin\Blog\UpdateRequest;
...
class BlogController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content::admin.blog.index', compact('title', 'routeData', 'dataTable'));
    }
        ...
        try {
            ...
            return DataTables::eloquent($blogs)
                ...
                ->addColumn('action', function ($blog) {
                    return Helper::btnMaker(BtnType::Warning, route('admin.content.blog.edit', $blog->id), trans('panel.action.edit'));
                })
                ->make();
    ...
    public function create()
    {
        ...
        return view('content::admin.blog.create', compact('title'));
    }
    ...
    public function edit(Blog $blog)
    {
        ...
        return view('content::admin.blog.edit', compact('title', 'blog'));
    }
    ...
    {
        return route('admin.content.blog.data');
    }
