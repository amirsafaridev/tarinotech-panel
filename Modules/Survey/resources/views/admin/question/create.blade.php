            ...
            <div class="card">
                ...
                <div class="card-body pb-4">
                    ...
                    <form class="request-form forms-sample" method="post"
                        ...
                        <!-- تنظیمات متن کوتاه -->
                        <div id="short-text-options" class="mt-4 mb-3 p-3 d-none">
                            <h5>تنظیمات ورودی متن کوتاه</h5>
                            <div class="row">
                                <div class="col-md-6">
                                    <x-admin.input identify="settings[minLength]" title="حداقل تعداد کاراکتر" type="number" min="0" :old="request('settings.minLength')" />
                                </div>
                                <div class="col-md-6">
                                    <x-admin.input identify="settings[maxLength]" title="حداکثر تعداد کاراکتر" type="number" min="1" :old="request('settings.maxLength')" />
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <x-admin.input identify="settings[placeholder]" title="متن راهنما (Placeholder)" :old="request('settings.placeholder')" />
                                </div>
                            </div>
                            <div class="alert alert-info mt-3">
                                <i class="fa fa-info-circle me-2"></i>
